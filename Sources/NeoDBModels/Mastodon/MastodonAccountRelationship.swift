...
public struct MastodonAccountRelationship: Codable, Equatable, Identifiable {
    ...
    public static func placeholder() -> MastodonAccountRelationship {
        .init(
            id: UUID().uuidString,
            following: false,
...
public extension MastodonAccountRelationship {
