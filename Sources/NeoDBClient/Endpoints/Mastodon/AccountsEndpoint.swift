...
public struct MastodonAccountMuteData: Encodable, Sendable {
    let duration: Int
...
public struct MastodonAccountRelationshipNoteData: Encodable, Sendable {
    let comment: String
...
public struct MastodonAccountUpdateCredentialsData: Encodable, Sendable {
